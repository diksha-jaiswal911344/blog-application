...
public class PostServiceImpl implements PostService {
    ...
    @Override
    public PostDto updatePost(PostDto postDto, String id, MultipartFile file) {
    ...
    @Override
    public List<PostDto> getPostsByCategoryId(String categoryId) {
    ...
    public List<PostDto> getUncategorizedPosts() {
        Category uncategorized = categoryRepository.findByCategoryName("Uncategorized")
                .orElseThrow(() -> new RuntimeException("uncategorized not found"));
    ...
    private Post mapToEntity(PostDto postDto) {
        Post post = new Post();
        // If id exists in the DTO (for updates), set it
